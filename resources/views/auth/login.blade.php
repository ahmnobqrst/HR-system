...
@section('css')
    <style>
        ...
        .authentication {
            background: url("{{ asset('assets/images/authentication/Capital-Agro-logo.png') }}") no-repeat center center;
            ...
            <div class="row justify-content-center align-items-center h-100">
                <div class="col-xxl-6 col-xl-7 col-lg-7 col-md-7 col-sm-8 col-12">
                    <div class="p-5">
                        ...
                        <p class="mb-3 text-muted op-7 fw-normal">Welcome back Myfreiend !</p>
                        ...
                        <form action="{{ route('login') }}" method="post" class="theme-form">
                            ...
                            <div class="col-xl-12 mt-0">
                                ...
                                <input type="text" class="form-control form-control-lg" id="signin-username" placeholder="user name" name="email">
                            </div>
                    ...
                    <div class="swiper keyboard-control">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="text-fixed-white text-center p-2 d-flex align-items-center justify-content-center">
                                    <div>
                                        <div class="mb-5">
                                            <img src="{{ asset('assets/images/authentication/hr2.png')}}" class="authentication-image" alt="">
                                        </div>
