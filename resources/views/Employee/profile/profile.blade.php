...
<div class="container mt-5">
    <div class="profile-card">
        ...
        <div class="profile-body">
            <form action="{{ route('update.employee.profile', $employee->id) }}" method="post" enctype="multipart/form-data">
            ...
            : asset('images/user.jpeg') }}"
                    ...
                    <p class="text-light mb-0">{{ $employee->email }}</p>
                    <small>{{ __('Students_trans.employee') }}</small>
                </div>
                @csrf
                <div class="row mb-3">
                    <div class="col-md-4">
                        <label>{{ __('Students_trans.employee') }}</label>
                    </div>
                    <div class="col-md-8">
