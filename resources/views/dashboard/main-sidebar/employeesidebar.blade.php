            ...
            <ul class="main-menu">
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        <li class="slide">
                            <a href="{{route('get.employee.department')}}" class="side-menu__item text-capitalize">
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        <li class="slide">
                            <a href="{{ route('employee.attendance.history') }}" class="side-menu__item text-capitalize">
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        <li class="slide">
                            <a href="{{route('employee.all.leaves')}}" class="side-menu__item text-capitalize">
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        <li class="slide">
                            <a href="{{ route('get.employee.holidays') }}" class="side-menu__item text-capitalize">
                                <i class="bx bx-user-plus side-menu__icon"></i>{{ trans('words.Holidays') }}
                            </a>
                            <a href="{{route('get.employee.offical.holidays')}}" class="side-menu__item text-capitalize">
