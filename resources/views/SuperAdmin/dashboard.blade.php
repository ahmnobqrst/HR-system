...
@section('title')
{{ trans('words.Dashbord_superadmin') }}
@endsection
@push('css')
<style>
...
<div class="row g-3">
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card custom-card card-bg-secondary text-center">
            <div class="card-body d-flex flex-column align-items-center justify-content-center">
                ...
                <div class="fs-15 fw-semibold">{{$departments->count()}}</div>
                <p class="mb-2">{{ trans('words.all_departent') }}</p>
                <a href="{{route('get.all.departments')}}" class="text-white text-decoration-underline mt-2">{{ trans('words.Show_Details') }}</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card custom-card card-bg-info text-center">
            <div class="card-body d-flex flex-column align-items-center justify-content-center">
                ...
                <a href="{{route('get.all.employees')}}" class="text-white text-decoration-underline mt-2">{{ trans('words.Show_Details') }}</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card custom-card card-bg-success text-center">
            <div class="card-body d-flex flex-column align-items-center justify-content-center">
                ...
                <a href="{{route('present.employee')}}" class="text-white text-decoration-underline mt-2">{{ trans('words.Show_Details') }}</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card custom-card card-bg-danger text-center">
            <div class="card-body d-flex flex-column align-items-center justify-content-center">
                ...
                <a href="{{route('absent.employees')}}" class="text-white text-decoration-underline mt-2">{{ trans('words.Show_Details') }}</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card custom-card card-bg-warning text-center">
            <div class="card-body d-flex flex-column align-items-center justify-content-center">
                <div class="avatar mb-2"><i class="ri-user-unfollow-fill fs-28 text-white"></i></div>
                <div class="fs-15 fw-semibold">{{$lats->count()}}</div>
                <p class="mb-2">{{ trans('words.Today_late') }}</p>
                <a href="{{route('lats.employee')}}" class="text-white text-decoration-underline mt-2">{{ trans('words.Show_Details') }}</a>
            </div>
        </div>
    </div>
