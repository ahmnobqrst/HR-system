            ...
            <table class="table table-bordered text-center">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        {{-- عرض قسم الموظف لو موجود --}}
                        <td>
                            {{ $leave->user?->department?->getTranslation('name', app()->getLocale()) 
                                ?? trans('words.No_Department') }}
                        </td>
                        ...
                        <td>
                              <form action="{{ route('delete.all.leaves', $leave->id) }}" method="POST" style="display:inline-block;">
                                @csrf
