(function () {
    ...
    var pieBasic = {
        ...
        colors: ["#e6533c", "#23b7e5", "#f5b849", "#f5b569"],
        labels: ['Presennt Students', 'Absent Students', 'Excuted Student', 'Left Students'],
        legend: {
            position: "bottom"
        },
        dataLabels: {
    ...
    var chart1 = new ApexCharts(document.querySelector("#pie-basic"), pieBasic);
    chart1.render();
    ...
    var donutSimple = {
        ...
        colors: ["#e6533c", "#23b7e5", "#f5b849", "#f5b569"],
        labels: ['Lower Than 50%', 'From 50% To 75%', 'From 75% To 80%', 'Upper Than 90%'],
        dataLabels: {
            dropShadow: {
                enabled: false
            }
    ...
    var chart2 = new ApexCharts(document.querySelector("#donut-simple"), donutSimple);
    chart2.render();
    ...
    var options = {
        ...
        colors: ["#e6533c", "#23b7e5", "#f5b849", "#e6533c", "#49b6f5"],
        legend: {
            position: 'bottom',
        }
    };
    ...
    var options = {
        ...
        colors: ["#e6533c", "#23b7e5", "#f5b849", "#49b6f5", "#e6533c"],
        title: {
