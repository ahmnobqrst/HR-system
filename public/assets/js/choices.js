(function () {
    ...
    const secondElement = new Choices(
    ...
    const multipleCancelButton3 = new Choices(
        "#choices-multiple-remove-button3",
        {
            allowHTML: true,
            removeItemButton: true,
        }
    ...
    const multipleCancelButton5 = new Choices(
        "#choices-multiple-remove-button5",
        {
            allowHTML: true,
            removeItemButton: true,
        }
    ...
    const multipleCancelButton6 = new Choices(
        "#choices-multiple-remove-button6",
        {
            allowHTML: true,
            removeItemButton: true,
        }
