(function () {
    ...
    var chart2 = new ApexCharts(document.querySelector("#btcCoin"), options2);
    chart2.render();
    ...
    var chart3 = new ApexCharts(document.querySelector("#ethCoin"), options3);
    chart3.render();
    ...
    var chart4 = new ApexCharts(document.querySelector("#dshCoin"), options4);
    chart4.render();
    ...
    var chart5 = new ApexCharts(document.querySelector("#glmCoin"), options5);
    chart5.render();
