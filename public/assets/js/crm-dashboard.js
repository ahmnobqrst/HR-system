...
var main = new ApexCharts(document.querySelector("#crm-main"), main);
main.render();
/* Target Incomplete Chart */
...
var analytics = {
    ...
    colors: ["rgb(132, 90, 223)", "rgba(35, 183, 229, 0.85)", "rgba(119, 119, 142, 0.2)"],
    dataLabels: {
        enabled: false
    },
    grid: {
    ...
    legend: {
        show: true,
        customLegendItems: ['Profit', 'Revenue', 'Income'],
        inverseOrder: true
    },
    title: {
        text: 'Revenue Analytics with income & profit (USD)',
        align: 'left',
        style: {
            fontSize: '.8125rem',
            fontWeight: 'semibold',
...
var chart = new ApexCharts(document.querySelector("#crm-revenue-analytics"), analytics);
chart.render();
