(function () {
    ...
    var options = {
        ...
        colors: ['#46eab2', '#f6c264', '#43c1e9', '#e6533c'],
        grid: {
            borderColor: '#f2f5f7',
        },
        dataLabels: {
        ...
        title: {
            text: 'predicted Danger Percent Per Month',
            align: 'left',
            style: {
                fontSize: '13px',
                fontWeight: 'bold',
