(function () {
    ...
    var chart4 = new ApexCharts(document.querySelector("#bar-basic"), barBasic);
    chart4.render();
    ...
    var options = {
        ...
        title: {
            text: 'Predicted Smoke & Fire Dangers',
            style: {
                fontSize: '13px',
                fontWeight: 'bold',
                color: '#8c9097'
    ...
    var options = {
        ...
        colors: ["#26bf94", "#23b7e5", "#f5b849", "#e6533c", "#49b6f5"],
        grid: {
            borderColor: '#f2f5f7',
        },
        title: {
    ...
    var barFull = {
        ...
        title: {
            text: 'Comparison Between Deferent Danger Lines',
            style: {
                fontSize: '13px',
                fontWeight: 'bold',
                color: '#8c9097'
    ...
    var chart8 = new ApexCharts(document.querySelector("#bar-full"), barFull);
    chart8.render();
    ...
    var options = {
        ...
        colors: ["#26bf94", "#23b7e5", "#f5b849", "#e6533c", "#49b6f5", "#a65e76", "#5b67c7", "#a65e9a",
            "#26bf94", "#23b7e5"
        ],
        grid: {
            borderColor: '#f2f5f7',
    ...
    var options = {
        ...
        colors: ["#26bf94", "#23b7e5", "#f5b849", "#49b6f5"],
        title: {
