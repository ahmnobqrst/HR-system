...
var options30 = {
    ...
    colors: ["rgb(38, 191, 148)", "#f4bb5e"],
};
var chart30 = new ApexCharts(document.querySelector("#candidates-chart"), options30);
chart30.render();
function Candidates() {
    chart30.updateOptions({
        colors: ["rgb(" + myVarVal + ")", "#f4bb5e"],
    })
};
/* Candidates Chart */